...
import com.microsoft.azure.reactiveeventhubs.checkpointing.Backends.cassandra.lib.ColumnType.ColumnType

/** Column types supported
  */
private[reactiveeventhubs] object ColumnType extends Enumeration {
...
/** Create a column instance
  ...
  */
private[reactiveeventhubs] case class Column(val name: String, val `type`: ColumnType, val index: Boolean = false)
