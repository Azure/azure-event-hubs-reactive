...
import com.microsoft.azure.reactiveeventhubs.helpers.ISO8601DateTime
...
class MessageFromDevice(
  ...
  private[reactiveeventhubs] val deviceIdProperty = "iothub-connection-device-id"

  private[reactiveeventhubs] val messageIdProperty = AmqpConstants.AMQP_PROPERTY_MESSAGE_ID

  // TODO: use system property (AmqpConstants.AMQP_PROPERTY_CONTENT_TYPE ?)
  private[reactiveeventhubs] val contentTypeProperty = "$$contentType"

  // TODO: use system property
  private[reactiveeventhubs] val messageSchemaProperty = "$$MessageSchema"

  // TODO: use system property
  private[reactiveeventhubs] val creationTimeUtcProperty = "$$CreationTimeUtc"
